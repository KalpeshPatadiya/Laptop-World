                        ...
                        <form action="{{ url('update-sub-category/  ' . $subcategory->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" value="{{ $subcategory->slug }}" name="slug"
                                        class="form-control">
                                </div>
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    <input class="form-check-input" {{ $subcategory->popular == '1' ? 'checked' : '' }}
                                ...
                                @if ($subcategory->image)
                                    ...
                                    <img class="w-25 mb-3"
                                        src="{{ asset('assets/uploads/sub-category/' . $subcategory->image) }}" alt="">
                                @endif
                                <div class="form-group col-md-12 mb-3">
