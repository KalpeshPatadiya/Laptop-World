                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">Product Status</button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input type="text" value="{{ $products->name }}" name="name"
                                                class="form-control">
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            <label for="">Slug</label>
                                            <input type="text" value="{{ $products->slug }}" name="slug"
                                                class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4 mb-3">
                                            <label for="">MRP</label>
                                            <input type="number" value="{{ $products->MRP }}" name="MRP"
                                                class="form-control">
                                        </div>
                                        <div class="form-group col-md-4 mb-3">
                                ...
                                <div class="tab-pane fade" id="other" role="tabpanel" aria-labelledby="contact-tab">
                                    ...
                                    <div class="form-group col-md-4 mt-3 mb-3">
                                        <input class="form-check-input"
                                            {{ $products->new_arrivals == '1' ? 'checked' : '' }} type="checkbox"
                                            name="new_arrivals">
