            ...
            <div class="card">
                <div class="card-header bg-secondary">
                    <h3 class="text-white">Order View
                        ...
                        <a href="" class="btn btn-warning float-end" data-bs-toggle="modal" data-bs-target="#exampleModal">Cancel order</a>
                    </h3>
                </div>
                <div class="card-body">
                    <div class="row">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->price }}</td>
                                        <td>
                                            <img src="{{ asset('assets/uploads/products/' . $item->products->image) }}" alt="product img" width="100">
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
